...
from src.datamodules.datasets.spawrious import SpawriousExtracted
...
class SpawriousEmbContextsDatasetV2(BaseEmbContextsDatasetV2):
    """A dataset class for Spawrious in-context learning instances."""
    ...
    def __init__(self,
        ...
        super(SpawriousEmbContextsDatasetV2, self).__init__(
        ...
        test_diff_bg_set = dataset.get_subset("test_diff_bg")
        test_diff_class_set = dataset.get_subset("test_diff_class")
        test_all_diff_set = dataset.get_subset("test_all_diff")

        split_to_set = {
            'train': train_set,
            'val': val_set,
            'test_diff_bg': test_diff_bg_set,
            'test_diff_class': test_diff_class_set,
            'test_all_diff': test_all_diff_set
        }

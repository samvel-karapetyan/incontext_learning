...
class WaterbirdsDataModule(pl.LightningDataModule):
    """
        A PyTorch Lightning data module for the Waterbirds dataset.

        This module is designed to handle the loading and preprocessing of the Waterbirds dataset for
    ...
    def val_dataloader(self) -> DataLoader:
        """Returns a DataLoader for the validation subset of the Waterbirds dataset."""
    ...
    def test_dataloader(self) -> DataLoader:
        """Returns a DataLoader for the test subset of the Waterbirds dataset."""

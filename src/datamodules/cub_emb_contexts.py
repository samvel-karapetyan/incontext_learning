...
from src.datamodules.datasets import CUBEmbContextsDataset

log = logging.getLogger(__name__)


class CUBEmbContextsDataModule(pl.LightningDataModule):
    """
    A PyTorch Lightning Data Module for the CUB Embedding Contexts dataset.
    ...
    def __init__(self,
                 ...
                 spurious_setting,
                 *args, **kwargs):
        super(CUBEmbContextsDataModule, self).__init__()
    ...
    def setup(self,  *args, **kwargs):
        ...
        self._dataset = CUBEmbContextsDataset(self._dataset_path,
